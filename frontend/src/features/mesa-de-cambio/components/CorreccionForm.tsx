...
const correccionSchema = z.object({
  ...
  actividad_economica_cliente_oferente: z.string().max(10, 'Máximo 10 caracteres').optional(),
  ...
  actividad_economica_cliente_demandante: z.string().max(10, 'Máximo 10 caracteres').optional(),
