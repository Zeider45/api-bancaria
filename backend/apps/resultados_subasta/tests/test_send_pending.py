...
from apps.resultados_subasta import services
...
class SendPendingResultadosSubastaTests(TestCase):
    ...
    def test_sends_empty_payload_when_no_pending(self, mock_send_transaction):
        ...
        result = services.send_pending_resultados(webhook_url="https://webhook.example.test")
    ...
    def test_returns_error_when_no_pending_and_no_ente_code(self, mock_send_transaction):
        result = services.send_pending_resultados(webhook_url=None)
