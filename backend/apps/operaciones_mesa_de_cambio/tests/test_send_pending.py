...
from apps.operaciones_mesa_de_cambio import services
...
class SendPendingMesaDeCambioTests(TestCase):
    ...
    def test_sends_empty_payload_when_no_pending(self, mock_send_transaction):
        ...
        result = services.send_pending_operaciones(webhook_url="https://webhook.example.test")
    ...
    def test_returns_error_when_no_pending_and_no_ente_code(self, mock_send_transaction):
        result = services.send_pending_operaciones(webhook_url=None)
